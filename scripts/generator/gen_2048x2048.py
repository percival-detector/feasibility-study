...
class Worker(object):
    ...
    def doConfig(self):
        ...
        self.caPut('GDBotRightXChannel1', 255)
        self.caPut('GDBotRightYChannel1', 2047)
...
#        self.caPut('GDRemAddrChannel1',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel2',  256)
        self.caPut('GDTopLeftYChannel2',  0)
        self.caPut('GDBotRightXChannel2', 511)
        self.caPut('GDBotRightYChannel2', 2047)
...
#        self.caPut('GDRemAddrChannel2',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel3',  512)
        self.caPut('GDTopLeftYChannel3',  0)
        self.caPut('GDBotRightXChannel3', 767)
        self.caPut('GDBotRightYChannel3', 2047)
...
#        self.caPut('GDRemAddrChannel3',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel4',  768)
        self.caPut('GDTopLeftYChannel4',  0)
        self.caPut('GDBotRightXChannel4', 1023)
        self.caPut('GDBotRightYChannel4', 2047)
...
#        self.caPut('GDRemAddrChannel4',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel5',  1024)
        self.caPut('GDTopLeftYChannel5',  0)
        self.caPut('GDBotRightXChannel5', 1279)
        self.caPut('GDBotRightYChannel5', 2047)
...
#        self.caPut('GDRemAddrChannel5',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel6',  1280)
        self.caPut('GDTopLeftYChannel6',  0)
        self.caPut('GDBotRightXChannel6', 1535)
        self.caPut('GDBotRightYChannel6', 2047)
...
#        self.caPut('GDRemAddrChannel6',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel7',  1536)
        self.caPut('GDTopLeftYChannel7',  0)
        self.caPut('GDBotRightXChannel7', 1791)
        self.caPut('GDBotRightYChannel7', 2047)
...
#        self.caPut('GDRemAddrChannel7',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel8',  1792)
        self.caPut('GDTopLeftYChannel8',  0)
        self.caPut('GDBotRightXChannel8', 2047)
        self.caPut('GDBotRightYChannel8', 2047)
...
#        self.caPut('FilePath',            '/home/gnx91527', True)
        self.caPut('FileName',            '2048x2048.hdf5', True)
