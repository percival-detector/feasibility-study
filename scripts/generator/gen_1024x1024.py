...
class Worker(object):
    ...
    def doConfig(self):
        ...
        self.caPut('GDBotRightYChannel1', 1023)
...
#        self.caPut('GDRemAddrChannel1',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDBotRightYChannel2', 1023)
...
#        self.caPut('GDRemAddrChannel2',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel3',  256)
        self.caPut('GDTopLeftYChannel3',  0)
        self.caPut('GDBotRightXChannel3', 383)
        self.caPut('GDBotRightYChannel3', 1023)
...
#        self.caPut('GDRemAddrChannel3',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel4',  384)
        self.caPut('GDTopLeftYChannel4',  0)
        self.caPut('GDBotRightXChannel4', 511)
        self.caPut('GDBotRightYChannel4', 1023)
...
#        self.caPut('GDRemAddrChannel4',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel5',  512)
        self.caPut('GDTopLeftYChannel5',  0)
        self.caPut('GDBotRightXChannel5', 639)
        self.caPut('GDBotRightYChannel5', 1023)
...
#        self.caPut('GDRemAddrChannel5',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel6',  640)
        self.caPut('GDTopLeftYChannel6',  0)
        self.caPut('GDBotRightXChannel6', 767)
        self.caPut('GDBotRightYChannel6', 1023)
...
#        self.caPut('GDRemAddrChannel6',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel7',  768)
        self.caPut('GDTopLeftYChannel7',  0)
        self.caPut('GDBotRightXChannel7', 895)
        self.caPut('GDBotRightYChannel7', 1023)
...
#        self.caPut('GDRemAddrChannel7',   'cs04r-sc-serv-77')
        ...
        self.caPut('GDTopLeftXChannel8',  896)
        self.caPut('GDTopLeftYChannel8',  0)
        self.caPut('GDBotRightXChannel8', 1023)
        self.caPut('GDBotRightYChannel8', 1023)
...
#        self.caPut('FilePath',            '/home/gnx91527', True)
        self.caPut('FileName',            'perc_1024x1024.hdf5', True)
